<script src="<?php echo Config::get('application_path') .'assets/lib/jquery/dist/jquery.js'; ?>"></script>
...
<script src="<?php echo Config::get('application_path') .'assets/js/site.js'; ?>" asp-append-version="true"></script>
