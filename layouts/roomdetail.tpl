...
<div class="row">
        <div class="col-md-10">
            <form method="POST" action="<?php echo Config::get('application_path') .'admin/actions/roomdetail.php'?>" novalidate="novalidate">
            ...
            <input type="hidden" name="id" value="{$id}">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" data-val="true" data-val-required="The Room Name field is required." id="room_name" name="room_name" value="{$room_name}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" data-val="true" data-val-required="The Total Room field is required." id="total_room" name="total_room" value="{$total_room}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" data-val="true" data-val-required="The Occupancy field is required." id="occupancy" name="occupancy" value="{$occupancy}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" data-val="false" data-val-required="The Size field is required." id="size" name="size" value="{$size}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <input class="form-control" type="text" data-val="true" data-val-required="The Rate field is required." id="rate" name="rate" value="{$rate}">
